...
tinymce.PluginManager.add('autoresize', function(editor) {
	...
	function isFreeDistraction() {
		return editor.plugins.freedistraction && editor.plugins.freedistraction.isFreeDistraction();
	}
	...
	function resize(e) {
		...
		if (!body || (e && e.type === "setcontent" && e.initial) || isFullscreen() || isFreeDistraction()) {
			if (body && docElm) {
	...
	editor.on("nodechange setcontent keyup FullscreenStateChanged FreeDistractionStateChanged", resize);
