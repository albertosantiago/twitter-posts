...
define('TWITTER_ERRORS_ASYNC_PENDING', 0);
define('TWITTER_ERRORS_ALREADY_LIKE', 139);
define('TWITTER_ERRORS_ALREADY_UNLIKED', 144);

class TwitterService extends tmhOAuth
{
    use AccountTrait,
        BlockTrait,
        DirectMessageTrait,
